                                ...
                                <div class="dropdown-menu" aria-labelledby="message">
                                    ...
                                    <a class="dropdown-item media bg-flat-color-1" href="#">
                                        <span class="photo media-left"><img alt="avatar"
                                                src="/dashboard/images/avatar/1.jpg"></span>
                                    ...
                                    <a class="dropdown-item media bg-flat-color-4" href="#">
                                        <span class="photo media-left"><img alt="avatar"
                                                src="/dashboard/images/avatar/2.jpg"></span>
                                        <span class="message media-body">
                                    ...
                                    <a class="dropdown-item media bg-flat-color-5" href="#">
                                        <span class="photo media-left"><img alt="avatar"
                                                src="/dashboard/images/avatar/3.jpg"></span>
                                        <span class="message media-body">
                                    ...
                                    <a class="dropdown-item media bg-flat-color-3" href="#">
                                        <span class="photo media-left"><img alt="avatar"
                                                src="/dashboard/images/avatar/4.jpg"></span>
                                        <span class="message media-body">
                        ...
                        <div class="user-area dropdown float-right">
                            ...
                            <div class="user-menu dropdown-menu">
                                ...
                                <a onclick="event.preventDefault(); document.getElementById('logout-form').submit();"
                                    class="nav-link" href="{{ route('logout') }}"><i class="fa fa-power-off"></i>
                                    Logout</a>
                            </div>
                            <form class="logout-form hidden d-none" id="logout-form" action="{{ route('logout') }}"
                                method="POST">
                                @csrf
                            </form>
                        </div>
            ...
            <div class="breadcrumbs">
                <div class="col-sm-4">
                    <div class="page-header float-left">
                        <a href="{{ route('dashboard') }}" class="page-title">
                            <h1>Dashboard</h1>
                        </a>
                    </div>
                </div>
